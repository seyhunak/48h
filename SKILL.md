...
- **Docs:** **PDF + CSV generation** — server-side PDF (invoice, audit report, VAT roll-up) + CSV exports (exception queue, vault) — tested with real ZATCA/NPHIES field names.
