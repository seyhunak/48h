...
Autonomy rules:
- **Build without asking:** scaffold, spec, code, seed scripts, `npm run build`, `npm run test:e2e` (Track A) / `flutter test` (Track B), local `npm run dev` / `flutter run` on device, Cloudflare Tunnel preview, README/DEPLOY docs.
